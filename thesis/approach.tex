...
Formal specification functions have composition points where they can be
...
The edges of the specification automata defined above were labelled with
...
In the \textit{pythonrv} implementation, this formal verification procedure for
...
\begin{figure}[h!]
	\begin{minipage}{0.9\textwidth}
      ...
      \node[state] (s2) [below right of=s1] {$s_2$};
			\path
      (s0) edge node {$(\lambda_0 = \textit{func}, \delta_0 = \textit{func.inputs}[0] = 17)$} (s1)
