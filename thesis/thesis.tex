...
for the program. It is these last two types of specifications that we are
...
function returns, the realm of context-free grammars. LTL does not support this
\cite{barringer03eagle,barringer07ruler}.

\subsection{Temporal Rover}
...
the program executes, or a program execution is examined offline, transitions
